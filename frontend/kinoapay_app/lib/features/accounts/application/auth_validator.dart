...
class AuthValidator {
  ...
  static String? validateEmailOrPhone(String? value) {
    ...
    if (!emailRegex.hasMatch(value) && !phoneRegex.hasMatch(value)) return AppStrings.errorInvalidEmail;
    return null;
  }
  ...
  static String? validateBirthDateParts(String? day, String? month, String? year) {
    ...
    final mm = (month ?? "").trim();
    final yy = (year ?? "").trim();
    if (dd.isEmpty || mm.isEmpty || yy.isEmpty) return AppStrings.errorFieldRequired;
