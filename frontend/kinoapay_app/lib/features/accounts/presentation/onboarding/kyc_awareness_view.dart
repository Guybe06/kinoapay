          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildBenefit(icon: LucideIcons.arrowLeftRight, text: AuthStrings.kycBenefitTransfer),
                const SizedBox(height: 16),
                _buildBenefit(icon: LucideIcons.smartphone, text: AuthStrings.kycBenefitMobile),
                const SizedBox(height: 16),
