/// Chaînes de caractères pour la feature Envoi d'argent.
class SendStrings {
  ...
  static const String chooseSourceAccount = "Compte à débiter";
  ...
  static const String feeKinoa = "Frais KinoaPay";
