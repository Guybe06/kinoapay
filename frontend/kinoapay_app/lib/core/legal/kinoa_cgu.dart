...
abstract final class KinoaCgu {
  ...
  static const String a5Body =
      ...
      "retrait, conversion), le canal utilisé et le montant concerné. Ces frais sont "
      "affichés clairement à l'utilisateur avant toute confirmation et ne peuvent être "
      "prélevés sans son accord explicite. Winsa Ltd se réserve le droit de modifier "
  ...
  static const String a6Body =
      ...
      "la BEAC et la COBAC. Tout manquement entraîne la suspension immédiate du compte "
  ...
  static const String a7Body =
      ...
      "garantir une disponibilité absolue. Des interruptions planifiées pour maintenance "
      "peuvent survenir ; elles seront communiquées dans la mesure du possible avec un "
      "préavis raisonnable via l'application ou les canaux de communication officiels. "
  ...
  static const String a8Body =
      ...
      "frauduleuse du compte par un tiers non autorisé, d'une erreur de saisie de la part "
      "de l'utilisateur, ou d'une interruption de service imputable aux opérateurs tiers "
      "(MTN Mobile Money, Airtel Money, établissements bancaires partenaires). "
  ...
  static const String a9Body =
      ...
      "se conformer aux évolutions législatives, réglementaires ou techniques. "
      "L'utilisateur en est informé par notification dans l'application au moins "
      "15 jours avant l'entrée en vigueur des modifications. L'utilisation continue "
  ...
  static const String a10Body =
      ...
      "communautaires CEMAC applicables aux établissements de paiement. Tout litige "
      "relatif à l'interprétation ou à l'exécution des présentes est soumis à la "
      "juridiction compétente de Brazzaville, République du Congo, sauf disposition "
      "contraire expressément prévue par la réglementation CEMAC ou OHADA applicable. "
